...
import { Nullable, PrizesResponse } from 'src/components/models'

export type RootState = {
  counter: number;
  prizes: Nullable<PrizesResponse>;
  loading: boolean;
  hasError: boolean;
  error: unknown;
};
